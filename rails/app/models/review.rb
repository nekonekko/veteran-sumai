...
class Review < ApplicationRecord
  ...
  validates :username, :gender, :age, :property_address, :property_type, :sale_count,
            ...
            :transfered_on, :sale_speed_evaluation, :assessed_price, :sale_price, :price_reduced,
  ...
  validates :age, :assessed_price, :sale_price, :contract_price, :reduced_price,
            numericality: { only_integer: true }, allow_nil: true
  validates :sale_speed_evaluation, :company_response_evaluation, :sale_price_evaluation,
            numericality: { greater_than_or_equal_to: 1, less_than_or_equal_to: 5 },
            allow_nil: true

  validates :price_reduction_how_many_month, presence: true, if: :price_reduced?

  enum sale_count: { '初めて' => 0, '2回目' => 1, '3回以上' => 3 }
  enum mediation_contract_form: { '専属専任媒介契約' => 0, '専任媒介契約' => 1, '一般媒介契約' => 3, 'わからない' => 4 }
